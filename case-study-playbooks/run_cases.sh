...
# Usage: bash case-study/run_cases.sh [--dry-run] [--case A1|A2|A3|A4|A5|A6|A7|A8|A9|B1|B2|C1|all]
#
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    -h|--help)
      echo "Usage: bash case-study/run_cases.sh [--dry-run] [--case A1|A2|A3|A4|A5|A6|A7|A8|A9|B1|B2|C1|all]"
      exit 0 ;;
...
run_case "A9" \
  ...
  "variant-effect" "route" \
  "borzoi-workflows-variant-effect-workflow" "" "borzoi-workflows"
